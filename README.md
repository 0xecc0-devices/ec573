...
1. Due to the absense of Amiga Zorro Autoconfig signals **cfgin** and **cfgout** on the CPU slot, a snooping mechanism waits for all other devices to be configured first. This snooping mechanism needs at least Kickstart v37.299 to work correctly. Kickstarts 1.3 or earlier are
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU0OTE2MTEyM119
-->