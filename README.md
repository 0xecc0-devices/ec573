...
4. The IDE controller uses [lide.device](https://github.com/LIV2/lide.device) by Matt Harlum as autoboot firmware thus having all it's limitations.
5. The expansion always configures last in the autoconfiguration chain and uses the remaining resources available.
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0NDU0OTExNDFdfQ==
-->